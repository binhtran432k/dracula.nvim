...
function M.get(c)
  return {
    ...
    BufferInactive = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = util.blend_bg(c.gutter.fg, 0.8) },
    BufferInactiveERROR = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = util.blend_bg(c.red, 0.8) },
    BufferInactiveHINT = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = util.blend_bg(c.teal, 0.8) },
    BufferInactiveINFO = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = util.blend_bg(c.cyan, 0.8) },
    BufferInactiveIndex = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = c.gutter.fg },
    BufferInactiveMod = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = util.blend_bg(c.yellow, 0.8) },
    BufferInactiveSign = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = c.bg },
    BufferInactiveTarget = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = c.red },
    BufferInactiveWARN = { bg = util.blend_bg(c.gutter.bg, 0.4), fg = util.blend_bg(c.yellow, 0.8) },
    BufferOffset = { bg = c.statusline, fg = c.gutter.fg },
    BufferTabpageFill = { bg = util.blend_bg(c.gutter.bg, 0.8), fg = c.gutter.fg },
